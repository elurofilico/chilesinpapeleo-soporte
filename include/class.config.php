...
class Config {
    ...
    function updatePref($var,&$errors) {
        ...
        $f=array();
        $f['helpdesk_url']=array('type'=>'string',   'required'=>1, 'error'=>'Helpdesk URL erforderlich'); //TODO: Add url validation
        ...
        $f['time_format']=array('type'=>'string',   'required'=>1, 'error'=>'Formato de hora Requerido'); //TODO: Add date format validation  
