...
function cs_click(e) {
	var a_date = calvalarr[evtTgt(EvtObj(e)).id.substring(1,evtTgt(EvtObj(e)).id.length)].split('/');
	updobj.value=a_date[1]+'/'+a_date[0]+'/'+a_date[2];
	getObj('fc').style.display='none';
	
}

var mn=new Array('ENE','FEB','MAR','ABR','MAY','JUN','JUL','AGO','SEP','OCT','NOV','DIC');
